...
async function cargar() {
  ...
  try {
    ...
    if (!res.ok || data.error) {
      document.getElementById('main').innerHTML = stateErrorHTML(data.error || 'Error', 'cargar');
      return;
    }
    render(data);
  } catch(e) {
    document.getElementById('main').innerHTML = stateErrorHTML('Error de conexión', 'cargar');
  }
}
