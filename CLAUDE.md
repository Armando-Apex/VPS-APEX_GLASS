...
# Última actualización: 16 septiembre 2026 | Próximo UPD disponible: UPD-589
...
| ALTA | Armando | **Descuento por Encuesta de Satisfacción (UPD-588) — backend construido y probado, falta dar de alta el Flow en Meta.** JSON del Flow de 5 preguntas listo en `docs/whatsapp_flow_encuesta_satisfaccion.json`. Falta: (1) que Armando dé de alta el Flow en Meta Flow Builder (con su propio `flow_id`); (2) decidir si reemplaza la plantilla `encuesta_clientes` existente (que hoy apunta a un Flow viejo de solo 3 preguntas) o es una plantilla nueva aparte; (3) prueba visual — campo "Código de Encuesta" en Cotización, y una respuesta real de WhatsApp generando el código y mandándolo por el chat | Pendiente — falta alta en Meta + prueba visual |
...
Próximo UPD disponible: **UPD-589**
