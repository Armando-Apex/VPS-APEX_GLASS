...
# Última actualización: 19 agosto 2026 | Próximo UPD disponible: UPD-525
...
| ALTA | Armando | Sprint 2 S2-11 (CSRF, UPD-504): falta prueba visual en navegador — guardar/editar en 2-3 módulos clave (Cotización, Finanzas, Inventario) para confirmar que el token no rompió nada | Pendiente — falta prueba visual |
...
Próximo UPD disponible: **UPD-522**
...
**Próximo UPD disponible: UPD-525**
