...
| UPD-210 | 25-jun | Mando | Croquis nueva forma `esq` (Esquinero de vidrio): triángulo rectángulo con selector de 4 esquinas (Sup Izq/Der, Inf Izq/Der, default Inf Izq); _buildPath genera triángulo según esquina seleccionada; aplica en editor y PDF |
